...
class CustomerResourceIT {
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].hassecuritydeposit").value(hasItem(DEFAULT_HASSECURITYDEPOSIT)))
            .andExpect(jsonPath("$.[*].securitydepositamount").value(hasItem(DEFAULT_SECURITYDEPOSITAMOUNT.doubleValue())))
            .andExpect(jsonPath("$.[*].paybycash").value(hasItem(DEFAULT_PAYBYCASH)))
            .andExpect(jsonPath("$.[*].cashpaymentbeforeload").value(hasItem(DEFAULT_CASHPAYMENTBEFORELOAD)))
            .andExpect(jsonPath("$.[*].cashlastinvoicebeforeload").value(hasItem(DEFAULT_CASHLASTINVOICEBEFORELOAD)))
            .andExpect(jsonPath("$.[*].paybycredit").value(hasItem(DEFAULT_PAYBYCREDIT)))
            .andExpect(jsonPath("$.[*].creditoneweekcheck").value(hasItem(DEFAULT_CREDITONEWEEKCHECK)))
            .andExpect(jsonPath("$.[*].creditpaymentbydays").value(hasItem(DEFAULT_CREDITPAYMENTBYDAYS)))
            .andExpect(jsonPath("$.[*].haspurchasingdeposit").value(hasItem(DEFAULT_HASPURCHASINGDEPOSIT)))
            .andExpect(jsonPath("$.[*].hassecuritydepositbond").value(hasItem(DEFAULT_HASSECURITYDEPOSITBOND)))
            .andExpect(jsonPath("$.[*].hasassestsdeposit").value(hasItem(DEFAULT_HASASSESTSDEPOSIT)))
            ...
            .andExpect(jsonPath("$.[*].hascreaditlimit").value(hasItem(DEFAULT_HASCREADITLIMIT)))
            ...
            .andExpect(jsonPath("$.[*].isregistered").value(hasItem(DEFAULT_ISREGISTERED)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.hassecuritydeposit").value(DEFAULT_HASSECURITYDEPOSIT))
            .andExpect(jsonPath("$.securitydepositamount").value(DEFAULT_SECURITYDEPOSITAMOUNT.doubleValue()))
            .andExpect(jsonPath("$.paybycash").value(DEFAULT_PAYBYCASH))
            .andExpect(jsonPath("$.cashpaymentbeforeload").value(DEFAULT_CASHPAYMENTBEFORELOAD))
            .andExpect(jsonPath("$.cashlastinvoicebeforeload").value(DEFAULT_CASHLASTINVOICEBEFORELOAD))
            .andExpect(jsonPath("$.paybycredit").value(DEFAULT_PAYBYCREDIT))
            .andExpect(jsonPath("$.creditoneweekcheck").value(DEFAULT_CREDITONEWEEKCHECK))
            .andExpect(jsonPath("$.creditpaymentbydays").value(DEFAULT_CREDITPAYMENTBYDAYS))
            .andExpect(jsonPath("$.haspurchasingdeposit").value(DEFAULT_HASPURCHASINGDEPOSIT))
            .andExpect(jsonPath("$.hassecuritydepositbond").value(DEFAULT_HASSECURITYDEPOSITBOND))
            .andExpect(jsonPath("$.hasassestsdeposit").value(DEFAULT_HASASSESTSDEPOSIT))
            ...
            .andExpect(jsonPath("$.hascreaditlimit").value(DEFAULT_HASCREADITLIMIT))
            .andExpect(jsonPath("$.accountid").value(DEFAULT_ACCOUNTID))
            .andExpect(jsonPath("$.accountcode").value(DEFAULT_ACCOUNTCODE))
            .andExpect(jsonPath("$.isregistered").value(DEFAULT_ISREGISTERED))
