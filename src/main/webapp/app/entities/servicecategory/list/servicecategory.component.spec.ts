...
import { sampleWithRequiredData } from '../servicecategory.test-samples';
...
describe('Servicecategory Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.servicecategories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to servicecategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getServicecategoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getServicecategoryIdentifier).toHaveBeenCalledWith(entity);
