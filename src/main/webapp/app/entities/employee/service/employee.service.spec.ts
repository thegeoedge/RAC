...
const requireRestSample: RestEmployee = {
  ...
  nicIssueDate: sampleWithRequiredData.nicIssueDate?.format(DATE_FORMAT),
  passportIssueDate: sampleWithRequiredData.passportIssueDate?.format(DATE_FORMAT),
  passportExpDate: sampleWithRequiredData.passportExpDate?.format(DATE_FORMAT),
  dateOfBirth: sampleWithRequiredData.dateOfBirth?.format(DATE_FORMAT),
  marriedDate: sampleWithRequiredData.marriedDate?.format(DATE_FORMAT),
  empRegDate: sampleWithRequiredData.empRegDate?.format(DATE_FORMAT),
  lmd: sampleWithRequiredData.lmd?.toJSON(),
  dateJoined: sampleWithRequiredData.dateJoined?.toJSON(),
  dateResigned: sampleWithRequiredData.dateResigned?.toJSON(),
};
