...
import { AutojobsinvoiceComponent } from './autojobsinvoice.component';
import SpyInstance = jest.SpyInstance;

describe('Autojobsinvoice Management Component', () => {
  let comp: AutojobsinvoiceComponent;
  let fixture: ComponentFixture<AutojobsinvoiceComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AutojobsinvoiceComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(AutojobsinvoiceComponent);
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.autojobsinvoices?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
