...
@Component({
  standalone: true,
  selector: 'jhi-servicesubcategory',
...
export class ServicesubcategoryComponent implements OnInit {
  ...
  servicesubcategories?: IServicesubcategory[];
  isLoading = false;
  ...
  delete(servicesubcategory: IServicesubcategory): void {
    const modalRef = this.modalService.open(ServicesubcategoryDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.servicesubcategory = servicesubcategory;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.servicesubcategories = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IServicesubcategory[] | null): IServicesubcategory[] {
    return data ?? [];
  }
