...
import { sampleWithRequiredData } from '../system-settings.test-samples';
...
describe('SystemSettings Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to systemSettingsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSystemSettingsIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSystemSettingsIdentifier).toHaveBeenCalledWith(entity);
