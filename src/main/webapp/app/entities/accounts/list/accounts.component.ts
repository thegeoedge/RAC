...
import { AccountsService, EntityArrayResponseType } from '../service/accounts.service';
...
export class AccountsComponent implements OnInit {
  ...
  protected fillComponentAttributesFromResponseBody(data: IAccounts[] | null): IAccounts[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.accountsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
