...
import { sampleWithRequiredData } from '../voucher.test-samples';
...
describe('Voucher Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to voucherService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVoucherIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVoucherIdentifier).toHaveBeenCalledWith(entity);
