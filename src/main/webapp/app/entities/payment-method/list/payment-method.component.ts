...
export class PaymentMethodComponent implements OnInit {
  ...
  trackId = (item: IPaymentMethod): number => this.paymentMethodService.getPaymentMethodIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.paymentMethods.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IPaymentMethod[]): IPaymentMethod[] {
